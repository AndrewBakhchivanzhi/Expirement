...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Andrey\PycharmProject\Expirements\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Andrey\PycharmProject\Expirements\venv\Scripts\deactivate.nu'
